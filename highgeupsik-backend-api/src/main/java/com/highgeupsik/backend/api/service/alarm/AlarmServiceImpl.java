package com.highgeupsik.backend.api.service.alarm;

import com.highgeupsik.backend.api.repository.EmitterRepository;
...
public class AlarmServiceImpl implements AlarmService {
    ...
    public void sendToClient(SseEmitter emitter, String id, Object data) {
        try {
            ...
            throw new SseException(ErrorMessages.SSE_CONNECT_ERROR);
        }
    }
